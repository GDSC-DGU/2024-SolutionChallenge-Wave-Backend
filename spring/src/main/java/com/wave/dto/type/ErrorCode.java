...
public enum ErrorCode {
    ...
    NOT_FOUND_COUNTRY(40405, HttpStatus.NOT_FOUND, "존재하지 않는 국가입니다" ),
    ...
    INVALID_SOCIAL_TYPE(40007, HttpStatus.BAD_REQUEST, "지원하지 않는 소셜타입니다"),
    ...
    INVALID_CRAWLING_RESULT(50002,HttpStatus.INTERNAL_SERVER_ERROR, "크롤링 결과가 유효하지 않습니다."),
    INVALID_CRAWLING_DATE(50003,HttpStatus.INTERNAL_SERVER_ERROR, "크롤링 날짜가 유효하지 않습니다."),
